%% GUI for manual cropping

FEATURES_DIR = '.';
%addpath(genpath(FEATURES_DIR));
    
in_root_dir = '/data/DATASETS/iCubWorld30/test/venerdi26';
check_input_dir(in_root_dir);

out_root_dir = '~/data/DATASETS/iCubWorld30/test/venerdi26';
check_output_dir(out_root_dir);

reg_file = '~/data/DATASETS/iCubWorld30/test/venerdi26_registry.txt';
