...
conf.dataDir = './data/fv';
conf.cacheDir = ['./cache/fv/' day];
...
model_feat.numSpatialX = conf.numSpatialX;
model_feat.numSpatialY = conf.numSpatialY;
model_feat.quantizer = conf.quantizer ;
model_feat.vocab = [] ;
