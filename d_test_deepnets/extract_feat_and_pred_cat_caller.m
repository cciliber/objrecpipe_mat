...
if ~isempty(mapping)
    ...
    % transformation
    setlist.transf_lists_all = { {1:Ntransfs, 1:Ntransfs, 1:Ntransfs}; {1, 1, 1} };
    ...
    % objects per category
    setlist.obj_lists_all = { {1:NobjPerCat} };
    
    % transformation
    setlist.transf_lists_all = { {1:Ntransfs} };
...
extract_feat_and_pred_cat(question_dir, ...
    dset_dir, ...
    mapping, ...
