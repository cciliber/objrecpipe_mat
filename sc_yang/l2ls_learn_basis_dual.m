...
if verLessThan('matlab', '8.3.0')
    ...
    % ATTENTION: since r2014a, matlab by default uses the 'interior-points'
    % algorithm, that requires the definition of a 'HessFcn' property in options
    % if you want to continue using the default algorithm of the previous versions,
    % you should specify it by adding: (...'Algorithm', 'trust-region-reflective')
